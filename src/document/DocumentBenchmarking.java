...
public class DocumentBenchmarking {
	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			String testfile = getStringFromFile(textfile,numToCheck);
			
			long startTime = System.nanoTime();
			for(int i=0; i>trials ; i++){
				BasicDocument NewBasic = new BasicDocument(testfile);
			...
			for(int i=0; i>trials ; i++){
				EfficientDocument NewEfficient = new EfficientDocument(testfile);
				NewEfficient.getFleschScore();
			}
			System.out.print((System.nanoTime() - startTime)+"\n");
